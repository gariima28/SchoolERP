...
import { addNewFeeApi, getAllFeeDiscountApi } from 'src/Utils/Apis';
            ...
            <div className="row">
                <form className='pt-2' onSubmit={handleSubmit(AddFee)}>
                    ...
                    <p className='text-center p-4'>
                        ...
                        <button type="button" className="btn cancelButtons ms-2" data-bs-dismiss="modal" onClick={() => handleCancel()}>Cancel</button>
                    </p>
                </form>
            </div>
        </div>
