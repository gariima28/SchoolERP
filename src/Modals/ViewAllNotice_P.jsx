...
import { getAllHolidayDataApi, getAllNoticeDataApi } from 'src/Utils/Apis';
...
const ViewAllNotice = ({ viewState, dataById }) => {
    ...
    const getAllNotices = async () => {
        try {
            setloaderState(true);
            var response = await getAllNoticeDataApi(pageNo, pageSize);
                            ...
                            <table className="table align-middle table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <td className='textWrapClass font14'>Notice Details</td>
                                        <td className='textWrapClass font14'>Date</td>
                                        <td className='textWrapClass font14 text-center'>Actions</td>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    {NoticeData.map((item, index) => (
                                        <tr key={item.noticeId}>
                                            ...
                                            <td className='font14 textWrapClass greyText'>{item.noticeTitle}</td>
                                            <td className='font14 textWrapClass greyText'>{item.noticeDate}</td>
                                            <td className='font14 textWrapClass text-center'>
