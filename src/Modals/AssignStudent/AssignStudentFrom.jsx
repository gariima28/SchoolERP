                ...
                <div className="container-fluid">
                    <div className="row">
                        <form className='p-3' onSubmit={handleSubmit(AssignStudentData)}>
                            <div className="mb-3">
                                <label htmlFor="vehicleNo" className="form-label font14">Vehicle  <span className='text-danger'>*</span></label>
                            ...
                            <div className="mb-3">
                                <label htmlFor="sec" className="form-label font14">Section  <span className='text-danger'>*</span></label>
                            ...
                            <div className="mb-3">
                                <label htmlFor="studentId" className="form-label font14">Student  <span className='text-danger'>*</span></label>
                            ...
                            <div className="mb-3">
                                <label htmlFor="dropId" className="form-label font14">Drop Point  <span className='text-danger'>*</span></label>
