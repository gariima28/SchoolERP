...
import { GetApi } from 'src/Utils/Apis'
import { SubscriptionDeleteApi } from 'src/Utils/Apis'
import { SubscriptionGetByIdApi } from 'src/Utils/Apis'
import { SubscriptionPutApi } from 'src/Utils/Apis'
import { PlanGetApi } from 'src/Utils/Apis'
          ...
          <div className='d-flex g-1 for-media-query'>
            <div className="row  me-2">
              ...
              <div className="col-3 p-0 ps-2" >
                <Link type="submit" className="btn btn-primary mb-3 heading-1 remove-shadow button-bg-color heading-14" style={{ border: '1px solid #008479', lineHeight: '1.2', display: 'flex' }} onClick={showName}>
                  ...
                  <p className='mb-0' style={{ fontSize: '15px' }}>Filter</p>
                </Link>
              </div>
            </div>
            ...
            <div className='me-2'>
              <div className="input-group mb-3 ">
                <input type="text" className="form-control form-focus input-border-color " style={{ height: '34px' }} onChange={handleChange} value={searchKey} placeholder="Search" aria-label="Recipient's username" aria-describedby="basic-addon2" />
