            ...
            <div className="container-fluid main-body p-3">
                ...
                <div className="main-content-conatainer pt-1 ">
                    ...
                    <div className='d-flex gap-2 header-1  mx-3 mt-3 '>
                        <div className="input-icon ps-2" style={{ marginTop: '2.5px' }}>
                            {/* <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/367638_paypal_icon 1.svg" alt="" /> */}
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='d-flex gap-2 header-1  mx-3 '>
                        <div className="input-icon ps-2" style={{ marginTop: '2.5px' }}>
                            {/* <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/Group.svg" alt="" /> */}
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
