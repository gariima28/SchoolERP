...
import { RequestGetApi, getAllDashDataApi, getDashDataApi } from 'src/Utils/Apis';
              ...
              <div className="card p-2 h-100">
                <div className="card-header bg-white ps-1 pe-1">
                  <div className="d-flex pb-2">
                    ...
                    <div className="flex-fill text-end"><Link className='greenText' to='/superadmin/schools/allSchools'><h2>View All</h2></Link></div>
                  </div>
                </div>
              ...
              <div className="card p-2 h-100">
                <div className="card-header bg-white ps-1 pe-1">
                  <div className="d-flex pb-2">
                    ...
                    <div className="flex-fill text-end"><Link className='greenText' to='/superadmin/packages'><h2>View All</h2></Link></div>
                  </div>
                </div>
                <div className="overflow-scroll">
                  <PackageDashboard />
              ...
              <div className="card p-2 h-100">
                <div className="card-header bg-white ps-1 pe-1">
                  <div className="d-flex pb-2">
                    ...
                    <div className="flex-fill text-end"><Link className='greenText' to='/superadmin/requests'><h2>View All</h2></Link></div>
                  </div>
                </div>
                {DashData?.requests.length > 0 ?
                  DashData?.requests.slice(0, 1).map((item, index) => (
                    <div key={item.requestId}>
                        ...
                        <div className="d-flex pt-2">
                          ...
                          <div className="flex-shrink text-end">
                            ...
                            <h2 className='p-1 ps-2 pe-2 text-white bgOrange rounded-4 text-decoration-none'>
                              {new Date(item?.registrationTime).toLocaleDateString('en-GB', {
                                day: 'numeric',
                                month: 'short',
                                year: 'numeric'
                              })}
                      ...
                      <div className="card-footer bg-white p-0 pt-2">
                        <h5 className='greyText fst-italic'>{item?.name} - {item?.registrationTime.split('T')[0]}</h5>
                      </div>
                    </div>
                  ))
