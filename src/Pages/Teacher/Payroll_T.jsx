          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                {/* <button type="button" class="btn-close" data-bs-dismiss="x" aria-label="Close" onClick={''}></button> */}
              </div>
              <div className="container-fluid ">
                  ...
                  <div className="row p-2">
                    <div className="col-2">
                      <p className='img-content'>
                        <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="./public/images/Group 266 (1).png" alt="" />
                      </p>
                    </div>
                    <div className="col-4 ps-0">
                      <div className="row">
                        <p style={{ color: '#008479', fontSize: 20 }}>{payrollStaffData?.staffName}</p>
                        ...
                        <div className="col-6 ps-0 pt-2" pt-2>
                          <ul className='heading-14 ul-2'>
                            <li>{payrollStaffData?.userRole}</li>
                            <li>{PayrolDataGetById?.monthYear}</li>
                            <li><p className='unpaid123' style={{ fontSize: 13 }}>{payrollStaffData?.staffStatus === true ? 'Active' : 'InActive'}</p></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    <div className="col-4 mt-4 pt-2">
                      <div className="row">
                        ...
                        <div className="col-6 ps-0 ">
                          <ul className='heading-14 ul-2'>
                            <li>{payrollStaffData?.staffEmail}</li>
                            <li>{payrollStaffData?.staffPhone}</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row table-class mt-4">
                  ...
                  <div className='d-flex justify-content-between'>
                    ...
                    <p className='pb-2'>{PayrolDataGetById?.allowance?.rent}</p>
                  </div>
                </div>
                <div className="row table-class mt-4">
                  <div className='' style={{ background: '#DDDDEB' }}>
                ...
                <div className="row table-class mt-4">
                  ...
                  <div className='d-flex justify-content-between'>
                    <p className='' >Basic</p>
                    <p className='pb-2'>{PayrolDataGetById?.basicPay}</p>
                  </div>
                  <hr />
                  <div className='d-flex justify-content-between'>
