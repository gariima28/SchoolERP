...
import Assign_archieves from 'src/Pages/Teacher/Assign_archieves_T';
import Assign_draft from './Assign_draft_T';
                ...
                <div className="bg-white rounded-2 p-2 ">
                  ...
                  </div>
                  {
                    search ?
                      <div className="row">
                        {
                          singleState === 'published' && (<Assign_publish data={data} update={updateHandle} />)
                        }
                        {
...
export default AssignmentTea_T
