            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap'>Leave Type</th>
                  <th className='no-wrap'>Leave Date</th>
                  <th className='no-wrap'>Days</th>
                  <th className='no-wrap'>Apply Date</th>
                  <th className='no-wrap'>Reason</th>
              ...
              <tbody className='heading-14 align-middle greyTextColor'>
                {
                  LeaveGetAllData && LeaveGetAllData?.length > 0 ? (
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    ...
                    <div className="mb-3" style={{ marginTop: '-6px' }}>
                      ...
                      <input type="date" className="form-control form-focus label-color  heading-14" value={fromDate} onChange={(e) => handleFromDate(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Select Leave Type" />
                    </div>
                    <div className='pt-1'>
                    ...
                    <div className="mb-3" style={{ marginTop: '-6px' }}>
                      ...
                      <input type="date" className="form-control form-focus label-color  heading-14" value={toDate} onChange={(e) => handleToDate(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Select Leave Type" />
                    </div>
                    <div className='pt-1'>
                    ...
                    <div className="mb-3" style={{ marginTop: '-6px' }}>
                      ...
                      <textarea class="form-control" placeholder="" id="floatingTextarea2" value={reason} onChange={(e) => handleReason(e.target.value)} style={{ height: "70px" }}></textarea>
                    </div>
                    <div className='pt-1'>
