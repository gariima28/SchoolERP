...
import { TeacherNoticePostApi } from 'src/Utils/Apis'
import { TeacherNoticeGetAllApi } from 'src/Utils/Apis'
import { TeacherNoticeCSV } from 'src/Utils/Apis'
import { TeacherNoticeDeleteApi } from 'src/Utils/Apis'
import { TeacherNoticeGetByIdApi } from 'src/Utils/Apis'
import { TeacherNoticePutApi } from 'src/Utils/Apis'
...
const Notice = () => {
  ...
  const IdTransfer = (id) => {
    navigate("/teacher/notice/view", { state: { id: id } })
  }
          ...
          {/* <div className='d-flex g-1 for-media-query'>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 ">
                <input type="text" className="form-control form-focus font-color" style={{ height: '34px' }} placeholder="Search Notice" aria-label="Recipient's username" onChange={handleChange} value={searchKey} aria-describedby="basic-addon2" />
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop1012" aria-controls="staticBackdrop" onClick={ClearData}>+ Add Notice</Link>
          </div> */}

        </div>
        <h5 className='ms-3 pt-2 mb-2 margin-minus22 heading-16 heading-responsive' style={{ marginTop: '-22px' }}>Notice Details</h5>
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  <th className='no-wrap' style={{ width: '10%' }}>#</th>
                  <th className='no-wrap' style={{ width: '60%' }}>Notice Details</th>
                  <th className='no-wrap' style={{ width: '' }}>Date</th>
                  ...
                  noticeAllData && noticeAllData?.length > 0 ? (
                    noticeAllData?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        {/* <td className='no-wrap greyText pe-0'>{item.noticeTitle}</td> */}
                           <td
                          className='greyText pe-0 no-wrap position-relative'
                          data-bs-toggle={item.noticeTitle.length > 17 ? "tooltip" : undefined}
                        ...
                        <td className='no-wrap greyText pe-0'>{item.noticeDate}</td>
                        <td className='no-wrap greyText  pe-0' >
              ...
              <div className="offcanvas-end offcanvas" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop1012" aria-labelledby="staticBackdropLabel" ref={offcanvasRef}>
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    <div className="mb-3" style={{ marginTop: '-6px' }}>
                      <label for="exampleFormControlInput1" className="form-label label-color heading-14">Notice heading</label>
                      <input type="email" className="form-control form-focus heading-14" value={noticeHeading} onChange={(e) => handleName(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Enter Notice Heading " />
                    </div>
                    <div className='pt-1'>
                      {isValidNameRequired && (
                        <p className='ms-1' style={{ color: 'red', fontSize: '14px', marginTop: '-18px' }}>
                    ...
                    <div className="mb-3" style={{ marginTop: '-6px' }}>
                      <label for="exampleFormControlInput1" className="form-label label-color heading-14">Description</label>
                      <textarea class="form-control heading-14 px-4" id="exampleFormControlTextarea1" rows="5" value={noticeDescription} onChange={(e) => handleDescription(e.target.value)} placeholder='Enter Notice Heading'>
                      </textarea>
                    </div>
                    <div className='pt-1'>
                      {isValidDscriptionRequired && (
