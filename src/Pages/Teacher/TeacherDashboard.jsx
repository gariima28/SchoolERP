...
const DashboardPage = () => {
  ...
  const MyAttendanceShowOfTeacher = async () => {
    try {
      ...
      console.log('All time table data api =============', response)
              ...
              <div className="row p-0" style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className="d-flex p-2">
                  <div className="flex-grow-1 align-self-center">
                    <p className='font14 padding-bottom'>Timetable Details</p>
                  </div>
                  <div>
              ...
              <div className='row p-0' style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className=" d-flex justify-content-between p-1" >
                  <div className="pt-2 ps-2">
                    <p className='padding-bottom'>Attendance</p>
                  </div>
                  <div className="">
          ...
          <div className="row cards  h-100" style={{ borderRadius: '8px 8px 0px 0px' }}>
            <div className="col-12">
              <div className="row p-0" style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className="d-flex p-2">
                  <div className="flex-grow-1 align-self-center">
                    <p className='font14 padding-bottom'>Assignment Details</p>
                  </div>
                  <Link className='p-1 ps-2 pe-2 rounded-2 borderOrange text-black text-decoration-none font12' type="button" to='/teacher/assignmenttea'><p className='padding-bottom' style={{ color: '#fff' }}>View All</p></Link>
                </div>
              </div>
              <div className="timeTableScroll">
                          ...
                          <div className="timeTableCard p-2">
                            <div className="row mb-2">
                              <div className="col-4 align-self-center">
                                <p className='greenText font16  padding-bottom'>{item.title}</p>
                              </div>
                              <div className="col-4 align-self-center">
                                <p className='font14 padding-bottom'>{item.subjectName}</p>
                              </div>
                              <div className="col-4 align-self-center">
                                <p className='font12 padding-bottom'></p>
                              </div>
                            </div>
                            <div className="row pt-1 heading-16">
                              <div className="col-2 align-self-center">
                                <p className='font12 greyText padding-bottom'>Class - {item.classNo}</p>
                              </div>
                              <div className="col-5 align-self-center">
                                <p className='font12 greyText padding-bottom'>Start Date - {item.StartDate}</p>
                              </div>
                              <div className="col-5 align-self-center">
                                <p className='font12 greyText padding-bottom'>End Date - {item.endDate}</p>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="row cards  h-100" style={{ borderRadius: '8px 8px 0px 0px' }}>
            <div className="col-12">
              <div className="row p-0" style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className="d-flex p-2">
                  <div className="flex-grow-1 align-self-center">
                    <p className='font14 padding-bottom'>Leave Report</p>
                  </div>
                  <Link className='p-1 ps-2 pe-2 rounded-2 borderOrange text-black text-decoration-none font12' type="button" to='/teacher/leave'><p className='padding-bottom' style={{ color: "#fff" }}>View All</p></Link>
                </div>
              </div>
              <div className="row px-2 pt-2">
                {
                    ...
                    leaveAllData?.map((item, index) => (
                      <div className="col-6 p-1" key={item.classRouteId}>
                        <div className='d-flex timeTableCard' >
                          <div className="p-2">
                            <p className='greenText font16 padding-bottom'>{item?.leaveType}</p>
                            <div className="d-flex pt-2">
                              <div className="flex-grow-1 align-self-center">
                                <p className='font12 padding-bottom'>Available {item?.leaveCount} day</p>
                                <p className='font12 padding-bottom'>Booked {item?.bookedCount} day</p>
                              </div>
                            </div>
                          </div>
                          {
          ...
          <div className="row cards  h-100" style={{ borderRadius: '8px 8px 0px 0px' }}>
            <div className="col-12">
              <div className="row p-0" style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className="d-flex p-2" >
                  <div className="flex-grow-1 align-self-center">
                    <p className='font14 padding-bottom'>Upcoming Events</p>
                  </div>
                  <Link className='p-1 ps-2 pe-2 rounded-2 borderOrange text-black text-decoration-none font12 ' to='/teacher/event' ><p className='padding-bottom' style={{ color: '#fff' }}>View All</p></Link>
                </div>
              </div>
              <div className="row px-2 pt-2">
                        ...
                        <div className="borderLeftOrange p-2">
                          <div className="d-flex p-1">
                            ...
                            <div className="flex-shrink" style={{ backgroundColor: '#FF914C', color: 'red', borderRadius: '10px', height: 'fit-content', padding: '2px 12px' }}>
                              <p className="font14 text-end padding-bottom {" style={{ color: '#fff', }}>{item.comingSoon ? "Coming Soon" : 'Upcoming'}</p>
                            </div>
          ...
          <div className="row cards  h-100" style={{ borderRadius: '8px 8px 0px 0px' }}>
            <div className="col-12">
              <div className="row p-0" style={{ backgroundColor: '#008479', borderRadius: '8px 8px 0px 0px', color: '#fff' }}>
                <div className="d-flex p-2">
                  <div className="flex-grow-1 align-self-center">
                    <p className='font14 padding-bottom'>Upcoming Holiday</p>
                  </div>
                  <Link className='p-1 ps-2 pe-2 rounded-2 borderOrange text-black text-decoration-none font12' type="button" to='/teacher/holiday'><p className='padding-bottom' style={{ color: '#fff' }}>View All</p></Link>
                </div>
              </div>
