...
import { TeacherProfileByIdAllApi } from 'src/Utils/Apis';
                        ...
                        <div className="col-lg-9">
                            ...
                            <div class="mb-3 " style={{ display: 'flex', }}>
                                ...
                                <div style={{ margin: 'auto', paddingTop: '30px', paddingLeft: '5px' }}>
                                    {
                                        swicthInput ? (
                                            <button type="button" class="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput(!swicthInput)} >Edit</button>
                                        )
                                            :
                                            (
                                                <button type="button" class="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput(!swicthInput)} >View</button>
                                            )
                                    }
                                </div>
                            </div>
