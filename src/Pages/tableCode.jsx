...
import { deletePlanApi, getAllActiveInActiveSpeFeatApi, getAllPlanApi, updateSpecialFeatureInSchoolApi } from 'src/Utils/Apis';
...
// ✅ MODIFIED: CSS में dropdown fixes add किए गए हैं
...
.table-striped>tbody>tr:nth-of-type(odd)>* {
  ...
  /* ✅ ADDED: Dropdown z-index और overflow fixes */
  .dropdown {
  ...
  /* ✅ ADDED: Table के लिए overflow visible */
...
const Packages = () => {
  ...
  const getAllPlans = async (searchKey) => {
    try {
      setloaderState(true);
      var response = await getAllPlanApi(searchKey === 'search' ? '' : searchKey, pageNo, pageSize);
      ...
      <ContainerCSS>
        ...
        <div className="container-fluid ps-3 pe-3 pt-2 pb-2">
          <div className="row pt-2">
            ...
            <div className="col-xl-6 col-lg-7 col-md-7 col-sm-12 mb-lg-0 mb-md-0 mb-3">
              <ActionControls
                ...
                addButtonAction={openAddPackageCanvas}
                showSearch={true}
          ...
          <div className="row ps-2 pe-2">
            {/* ✅ MODIFIED: cardradius container में style changes */}
            <div className="cardradius bg-white p-3" style={{position: 'relative'}}>
              {AllPlan.length > 0 ?
                <>
                  {/* ✅ MODIFIED: overflow-scroll को table-responsive-custom से replace किया */}
                  <div className="table-responsive-custom" style={{overflow: 'visible'}}>
                    <table className="table align-middle table-striped">
                      <thead>
                        <tr>
                          <th style={{ textWrap: 'nowrap' }}><h2>#</h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Package</h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Price <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/StatusArrow.svg" alt="" /></h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Interval <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/StatusArrow.svg" alt="" /></h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Period <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/StatusArrow.svg" alt="" /></h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Student Limit <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/StatusArrow.svg" alt="" /></h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Feature Details</h2></th>
                          <th style={{ textWrap: 'nowrap' }}><h2>Status <img onError={(e) => { e.target.onerror = null; e.target.src = "/images/fallback.png"; }} src="/images/StatusArrow.svg" alt="" /></h2></th>
                        ...
                        {AllPlan.map((item, index) => (
                          <tr key={item.planId} className={`my-bg-color align-middle`}>
                            ...
                            <td style={{ textWrap: 'nowrap' }}>
                              {/* ✅ MODIFIED: dropdown में style attribute add किया गया */}
                              <div className="dropdown dropdownbtn" style={{position: 'static'}}>
                                <button className="btn btn-sm actionButtons dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                  <span>Action</span>
                                </button>
                                {/* ✅ MODIFIED: dropdown-menu में z-index style add किया गया */}
                                <ul className="dropdown-menu" style={{ zIndex: '99999', position: 'absolute' }}>
                                  <li>
          ...
          {/* Rest of your modals remain the same - Add Package, Edit Package, Delete Package, Add Feature to Package, View Feature Package */}
                      ...
                      <>
                        ...
                        <div className="ps-3 pe-3">
                          ...
                          <p className='text-center p-3'>
                            ...
                            <button className='btn cancelButtons ms-3' data-bs-dismiss="offcanvas" aria-label="Close" onClick={handleCancel}>Cancel</button>
                          </p>
                        </div>
                      </>
                    )}
