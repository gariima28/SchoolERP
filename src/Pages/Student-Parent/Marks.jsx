...
const Marks = () => {
    ...
    const getAllMarks = async () => {
        try {
            setloaderState(true);
            var response = await getAllMarksDataApi(pageNo, pageSize);
                            ...
                            <table className="table align-middle table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <td className='textWrapClass font14'>Marks</td>
                                ...
                                <tbody>
                                    ...
                                    {MarksData.map((item, index) => (
                                        <tr key={item.holidayId}>
                                            ...
                                            <td className='textWrapClass font14 greyText'>{item.gainMarks}</td>
