...
const Marks = () => {
  ...
  const [marksSearch, setMarksSearch] = useState(false);
  ...
  const getAllMarks = async () => {
    try {
      setloaderState(true);
      var response = await getAllMarksDataApi('',pageNo, pageSize, selectedExam);
      ...
      if (response?.status === 200) {
        if (response?.data?.status === "success") {
          ...
          setTotalMarks(response?.data?.marksheet?.totalMaxMarks);
          setObtainedMarks(response?.data?.marksheet?.totalObtainedMarks);
          setGrade(response?.data?.marksheet?.grade);
          setPercentage(response?.data?.marksheet?.percentage);
          ...
          <div className="row mb-4">
            <p className="text-center p-3">
              <button
                ...
                onClick={() => {
                  setMarksSearch(true), getAllMarks();
                }}
              >
                Search
              </button>
              <button
                ...
                onClick={() => {
                  setMarksSearch(false), setSelectedExam("");
                }}
              >
                Cancel
              </button>
                    ...
                    <table className="table align-middle table-striped">
                      <thead>
                        <tr>
                          ...
                          <td className="textWrapClass font14">Obtained Marks</td>
                          <td className="textWrapClass font14">Maximum Marks</td>
                      ...
                      <tbody>
                        ...
                        {MarksData.map((item, index) => (
                          <tr key={item.holidayId}>
                            ...
                            <td className="textWrapClass font14 greyText"> {item?.totalMaxMarks} </td>
