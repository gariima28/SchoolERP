...
import { getAllTeachersDataApi } from 'src/Utils/Apis';
...
const Teacher = () => {
    ...
    const getAllTeachers = async () => {
        try {
            setloaderState(true);
            var response = await getAllTeachersDataApi(pageNo, pageSize);
                            ...
                            <table className="table align-middle table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <td className='textWrapClass font14'>Name</td>
                                        <td className='textWrapClass font14'>Department</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr></tr>
                                    {TeacherData.map((item, index) => (
                                        <tr key={item.holidayId}>
                                            ...
                                            <td className='textWrapClass font14 greyText'>{item.teacher}</td>
