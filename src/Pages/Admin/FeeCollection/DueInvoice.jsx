...
import { getAllClassApi, getAllDueInvoiceApi } from 'src/Utils/Apis';
                    ...
                    <div className="col-xxl-4 col-xl-3 col-lg-12 col-sm-12 flex-frow-1">
                        <nav className="mainBreadCrum font14 ps-0" aria-label="breadcrumb">
                            <ol className="breadcrumb mb-1">
                                ...
                                <li className="breadcrumb-item active bredcrumActiveText" aria-current="page">Due Invoice</li>
                            </ol>
                        </nav>
                        <p className="font14 ps-0 fontWeight500">Due Invoice</p>
                    </div>
                                    ...
                                    <>
                                        <div className="overflow-scroll">
                                            <table className="table align-middle table-striped">
                                                ...
                                                <tbody>
                                                    {DueInvoiceData.map((invoice, index) => (
