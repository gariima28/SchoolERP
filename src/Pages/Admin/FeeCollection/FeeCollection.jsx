...
const FeeCollection = () => {
    ...
    const [SingleInvoice, setSingleInvoice] = useState(true);
                ...
                <div className="container-fluid">
                    <div className="row p-3">
                        <div className="row pb-3">
                            ...
                            <p className='font14 ps-0 fontWeight500'>Fee Collection</p>
                        </div>
                        <div className="row pb-3">
                                ...
                                <div className="row border-bottom border-2 ">
                                    <div className="col-xxl-6 col-xl-12 col-sm-12 col-12">
                                        <div className="row pb-2 gap-sm-0 gap-3">
                                            <div className="col-md-5 col-sm-6 col-12 text-center">
                                                <span className={`font14 fontSizeResponsive fontWeight500 ps-3 pb-2 pe-3 ${SingleInvoice ? 'ActiveState' : 'InActiveState'}`} onClick={() => { setSingleInvoice(true); setBulkInvoice(false) }}>Create Single Invoice</span>
                                            </div>
                                            <div className="col-md-5 col-sm-6 col-12 text-center">
                                                <span className={`font14 fontSizeResponsive fontWeight500 ps-3 pb-2 pe-3 ${BulkInvoice ? 'ActiveState' : 'InActiveState'}`} onClick={() => { setSingleInvoice(false); setBulkInvoice(true) }}>Create Bulk Invoice</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    {SingleInvoice ? <CreateSingleInvoice /> : <CreateBulkInvoice />}
                                </div>
                            </div>
                        </div>
                    </div>
