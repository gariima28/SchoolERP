...
import { DepartmentPostApi } from 'src/Utils/Apis'
import { DepartmentGetAllApi } from 'src/Utils/Apis'
import { DepartmentDeleteApi } from 'src/Utils/Apis'
import { DepartmentGetById } from 'src/Utils/Apis'
...
const Departments = () => {
  ...
  const FuncValidation = () => {
    let isValid = true;
    // name 
    if (!departmentName || departmentName === "" || !/^[a-zA-Z0-9!@#$%^&*()_+=\- ]+$/.test(departmentName)) {
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 ">
                <input type="text" className="form-control form-focus font-color" style={{ height: '34px' }} placeholder="Search" onChange={handleChange} value={searchKey} aria-label="Recipient's username" aria-describedby="basic-addon2" />
            ...
            <table className="table table-sm  table-striped ">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap' style={{ width: '860px' }}>Department Name</th>
                  ...
                  departmentData && departmentData.length > 0 ? (
                    departmentData?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        <td className=' greyText no-wrap'>{item.departmentName}</td>
                ...
                <div className="offcanvas-body pt-0">
                  <div className="mb-1  ">
                    <div class="mb-3">
                      ...
                      <input type="email" class="form-control form-control-sm" id="exampleFormControlInput1" value={departmentName} onChange={(e) => handleTitle(e.target.value)} placeholder="Enter Department Name" />
                    </div>
                  </div>
                  <div>
                    {isValidNameRequired && (
