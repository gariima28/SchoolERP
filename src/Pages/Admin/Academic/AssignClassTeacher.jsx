...
import { GeyAllTeacherLightWeightGetAll } from 'src/Utils/Apis'
import { ClassGetApi } from 'src/Utils/Apis'
import { SectionRoomByIdGetApi } from 'src/Utils/Apis'
import { AssignClassTreachPostApi } from 'src/Utils/Apis'
import { AssignClassTeacherGetAllApi } from 'src/Utils/Apis'
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap' style={{ width: '100px' }}>Teacher</th>
                  <th className='no-wrap' style={{ width: '100px' }}>Class</th>
                  <th className='no-wrap' style={{ width: '100px' }}>Section </th>
                  <th className='no-wrap' style={{ width: '100px' }}>Actions</th>
                </tr>
              </thead>
                  ...
                  assignAllData && assignAllData?.length > 0 ? (
                    assignAllData?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        <td className=' greyText pe-0 no-wrap'>{item.className}</td>
