...
import { SectionPostApi } from 'src/Utils/Apis'
import { ClassGetApi } from 'src/Utils/Apis'
import { NullRoomGetApi } from 'src/Utils/Apis'
import { SectionRoomGetApi } from 'src/Utils/Apis'
import { SectionDeleteApi } from 'src/Utils/Apis'
import { SectionGetByIdApi } from 'src/Utils/Apis'
import { SectionPutApi } from 'src/Utils/Apis'
...
const Section = () => {
  ...
  // Remove section-room pair
  const removeSectionRoomPair = (index) => {
      ...
      <div className="container-fluid main-body p-3">
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop" onClick={ClearHandle}>+ ADD Section</Link>
          </div>
          ...
          <div className="table-container px-3 table-responsive">
            ...
            <table className="table table-sm table-striped">
              ...
              <tbody className='heading-14 align-middle greyTextColor greyText'>
                {
                  sectionAllDta && sectionAllDta?.length > 0 ? (
                    sectionAllDta?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        <td className=' greyText pe-0 no-wrap'>{item.sectionName}</td>
                        <td className=' greyText pe-0 no-wrap'>{item.roomNo}</td>
            ...
            <>
              <div className="offcanvas-end offcanvas" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel" ref={offcanvasRef}>
                <div className="offcanvas-header">
                  <Link data-bs-dismiss="offcanvas" onClick={ClearHandle}>
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    <div className="mb-1  ">
                      <label for="exampleFormControlInput1" className="form-label  heading-16">Class Name</label>
                    ...
                    <div>
                      {sections?.map((section, index) => (
                        <div className="row" key={index}>
                          <div className="col-6">
                            <div className="mb-1">
                              <label htmlFor={`section-${index}`} className="form-label heading-14">
                                Sections
                              </label>
                              <input
                                type="text"
                            ...
                            <div className="pt-1">
                              {isValidNameRequired && section.trim() === '' && (
                                <p className="ms-1" style={{ color: 'red', fontSize: '14px', marginTop: '-10px' }}>
                                  Section is required
                                </p>
                              )}
                            </div>
                          ...
                          <div className="col-6">
                            <div className="mb-1">
                              <label htmlFor={`room-${index}`} className="form-label heading-16">
                                Rooms
                              </label>
                              <select
                                className="form-select form-focus label-color heading-14"
                                // value={rooms}
                                value={rooms[index]}
                            ...
                            {index === sections.length - 1 ? (
                              ...
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                  <path fill="none" stroke="#008479" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m-7-7h14" />
                                </svg>
                              </button>
                            ) : (
                              <button
                              ...
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                  <g class="minus-outline">
                                    <path fill="red" fill-rule="evenodd" d="M21 12a1 1 0 0 1-1 1H4a1 1 0 1 1 0-2h16a1 1 0 0 1 1 1" class="Vector" clip-rule="evenodd" />
                                  </g>
                                </svg>
                              </button>
                            )}
