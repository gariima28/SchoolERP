...
import { ClassPostApi } from 'src/Utils/Apis'
import { ClassGetApi } from 'src/Utils/Apis'
import { ClassDeleteApi } from 'src/Utils/Apis'
import { ClassGetByIdApi } from 'src/Utils/Apis'
import { ClassPutApi } from 'src/Utils/Apis'
...
const ClassList = () => {
  ...
  const FuncValidation = () => {
    let isValid = true;
    // number 
    if (!classno || classno === "" || !/^[a-zA-Z0-9!@#$%^&*()_+=\- ]+$/.test(classno)) {
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap' style={{ width: '70%' }}>Class</th>
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    <div className="mb-3 " style={{ marginTop: '-18px' }}>
                      ...
                      <input type="text" className="form-control form-focus   label-color heading-14" value={classno} onChange={(e) => handleName(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Add Class No" />
                    </div>
                    <div className='pt-1'>
                      {isValidNameRequired && (
