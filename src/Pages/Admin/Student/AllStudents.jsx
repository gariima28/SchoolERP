...
import ViewStudentDetails from 'src/Modals/Student/ViewStudentDetails';
import EditStudentDetails from 'src/Modals/Student/EditStudentDetails';
  ...
  const handleKeyDown = (e) => {
    if (e.key === 'Backspace') {
      setTimeout(() => {
        ...
        if (updatedValue !== '') {
          getAllStudentData(updatedValue);
          setClick(true);
        }
          ...
          <div className="col-xl-9 col-md-12 col-sm-12 pe-0">
            <div className="row gap-sm-0 gap-3 justify-content-sm-none justify-content-between">
              ...
              <div className="col-md-4 col-sm-4 col-12">
                <div className="d-flex">
                  <input className="form-control formcontrolsearch" type="text" placeholder="Search" disabled={studentData.length > 0 ? false : true} value={searchByKey} onChange={(e) => setSearchByKey(e.target.value.trimStart())} onKeyDown={handleKeyDown} onCut={(e) => { e.preventDefault(); const pastedValue = e.clipboardData.getData('text') }} onPaste={(e) => { e.preventDefault(); const pastedValue = e.clipboardData.getData('text'); setSearchByKey(pastedValue.trimStart()); }} />
                  <button className="btn searchhhButtons text-white font14" type="button" disabled={studentData.length > 0 ? false : true} onClick={getAllStudentData}><h2>Search</h2></button>
                </div>
              ...
              <>
                <div className="overflow-scroll">
                  <table className="table align-middle table-striped">
                    <thead>
                      <tr>
                        <th><h2 className='textWrapClass'>#</h2></th>
                        <th><h2 className='textWrapClass'>Student Id</h2></th>
                        <th><h2 className='textWrapClass'>Name</h2></th>
                        <th><h2 className='textWrapClass'>Parents Name</h2></th>
                        <th><h2 className='textWrapClass'>Address</h2></th>
                        <th><h2 className='textWrapClass'>Phone</h2></th>
                        <th><h2 className='textWrapClass'>Email</h2></th>
                        <th><h2 className='textWrapClass'>Action</h2></th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr key={item.id} className='my-bg-color align-middle'>
                          ...
                          <td className='greyText textWrapClass'>
                            ...
                            {item.address.length > 60 ?
                              <>
                                <span className='me-2'> {item.address.substring(0, 30) + "..."}</span>
                                <button className='btn p-0' type='button' data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title={item.address}>
