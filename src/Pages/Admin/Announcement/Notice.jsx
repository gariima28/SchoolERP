...
const Notice = () => {
  ...
  const FuncValidation = () => {
    let isValid = true;
    // name 
    if (!noticeHeading || noticeHeading === "" || !/^[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~` ]+$/.test(noticeHeading)) {
    ...
    // description
    if (!noticeDescription || noticeDescription === "" || !/^[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~` ]+$/.test(noticeDescription)) {
  ...
  const IdTransfer = (id) => {
    navigate("/admin/notice/view", { state: { id: id } })
  }
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          {/* <div className='d-flex g-1 for-media-query'>
            <CSVLink className={`col-lg-2 col-md-3 col-sm-4 col-6 btn AddBtnn font14 heading-14 export1 my-own-outline-btn me-2 ${noticeAllData.length <= 0 ? 'disabled' : ''}`} data={csvData} filename={"orders.csv"}>
              <span>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop1012" aria-controls="staticBackdrop" onClick={ClearDataAndClose}>+ Add Notice</Link>
          </div> */}
          {/* new csv design */}
         <div className="d-flex g-1 for-media-query">
            <ActionControls
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap' style={{ width: '680px' }}>Notice Details</th>
                  ...
                  noticeAllData && noticeAllData?.length > 0 ? (
                    noticeAllData?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        <td className=' greyText pe-0 no-wrap'>{item.noticeTitle}</td>
                        <td className=' greyText pe-0 no-wrap'>{item.noticeDate}</td>
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    ...
                    <div className='my-button11 '>
                      ...
                      <button type="button" className="btn btn-outline-success" data-bs-dismiss="offcanvas" aria-label="Close" onClick={ClearDataAndClose}>Cancel</button>
                      {/* <Toaster /> */}
                    </div>
                  </div>
                </div>
