  ...
  const handleClassSelection = (classId) => {
    setSelectedClassIds(prev => {
      ...
      if (newSelection.length === allClassIds.length) {
        return [...allClassIds]; // Return all without adding "All" string
      }
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          {/* <div className='d-flex g-1 for-media-query'>
            <CSVLink className={`col-lg-2 col-md-3 col-sm-4 col-6 btn AddBtnn font16 heading-14 export1 my-own-outline-btn me-2 ${eventAllData?.length <= 0 ? 'disabled' : ''}`} data={csvData} filename={"orders.csv"}>
              <span>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop" onClick={ClearAndCancelHandle}>+ Add Event</Link>
          </div> */}
           {/* new csv design */}
            <div className="d-flex g-1 for-media-query">
            <ActionControls
