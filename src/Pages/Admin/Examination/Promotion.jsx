                            ...
                            <div className="bg-white rounded-2 p-4">
                                <form className="row g-3">
                                    ...
                                    <p className='text-center p-3'>
                                        <button type='button' className='btn addCategoryButtons2 text-white' disabled={nextClassId === '' || prevClassId === '' || prevSectionId === '' || nextSession === '' || nextSectionId === '' || prevClassId === '' || prevSectionId === '' || nextSession === ''} onClick={getAllPromotedStudentsData}>Manage Promotion</button>
                                        <button type='button' className='btn cancelButtons ms-3' disabled={nextClassId === '' || prevClassId === '' || prevSectionId === '' || nextSession === '' || nextSectionId === '' || prevClassId === '' || prevSectionId === '' || nextSession === ''}>Cancel</button>
                                    </p>
                                </form>
                                <div className="row">
                                    {SearchBtn
                                        ...
                                        <>
                                            <div className='overflow-scroll'>
                                                <table className="table align-middle table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th className='textWrapClasstext-center'><span className='font14'>#</span></th>
                                                            <th className='textWrapClass'><span className='font14'>Student Id</span></th>
                                                            <th className='textWrapClass'><span className='font14'>Student Name</span></th>
                                                            <th className='textWrapClass'><span className='font14'>Class</span></th>
                                                            <th className='textWrapClass'><span className='font14'>Section</span></th>
                                                    ...
                                                    <tbody>
                                                        {promotedStudents.map((student, index) => (
                                                            <tr key={student.id} className='my-bg-color align-middle'>
                                                                <th className='textWrapClass text-center greyText'><h3>{index + 1}</h3></th>
                                                                <td className='textWrapClass greyText'><h3>{student.studentId}</h3></td>
                                                                <td className='textWrapClass greyText'><h3>{student.studentName}</h3></td>
                                                                <td className='textWrapClass greyText'><h3>{student.classNo}</h3></td>
                                                                <td className='textWrapClass greyText'><h3>{student.classSection}</h3></td>
                                                                <td className='textWrapClass greyText'><h3></h3></td>
