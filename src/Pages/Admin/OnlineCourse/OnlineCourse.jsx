...
import { OnlinePostApi } from 'src/Utils/Apis'
import { ClassGetApi } from 'src/Utils/Apis'
import { TeacherGetTeacherGetAll } from 'src/Utils/Apis'
import { OnlineCourseGetAllApi } from 'src/Utils/Apis'
import { OnlineDeleteApi } from 'src/Utils/Apis'
import { OnlineGetById } from 'src/Utils/Apis'
import { OnlinePutApi } from 'src/Utils/Apis'
...
const OnlineCourse = () => {
  ...
  const [swicthInput2, setSwicthInput2] = useState(false)
  ...
  const MyTeacherGetAllApi = async () => {
    ...
    try {
      ...
      console.log('My teacher get all in online page', response)
      if (response?.status === 200) {
        // toast.success(response?.data?.message)
        setTeacherAllData(response?.data?.teacher)
        setLoader(false)
  ...
  const MyOnlineGetById = async (id) => {
    ...
    try {
      ...
      if (response?.status === 200) {
        ...
        setImageFile(response?.data?.course?.courseImage)
        setImageFile2(response?.data?.course?.courseFile)
  ...
  const MyOnlinePutApi = async (id) => {
    ...
    try {
      ...
      formData.append('courseFile', imageFile2)
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop" to={''} onClick={ClearHandle}>+ Add New Courses</Link>
          </div>
            ...
            <table className="table table-sm table-striped ">
              <thead className=''>
                <tr className='heading-16 text-color-000' >
                  ...
                  <th className='no-wrap'>Lesson and Section</th>
                  ...
                  onlineAllData && onlineAllData?.length > 0 ? (
                    onlineAllData?.map((item, index) => (
                      <tr className='heading-14' >
                        ...
                        <td className='greyText no-wrap'>{item.className}</td>
                        <td className=' greyText no-wrap'>
                ...
                <div className="offcanvas-body pt-0">
                  <div className="input " >
                    <div className="mb-1  ">
                      ...
                      <select className="form-select form-focus label-color heading-14" value={classId} onChange={(e) => setClassId(e.target.value)} aria-label="Default select example">
                    ...
                    <div className="mb-1  ">
                      ...
                      <select className="form-select  form-select-sm form-focus  label-color" value={courseSection} onChange={(e) => setCourseSection(e.target.value)} aria-label="Default select example">
                        <option selected>--Choose--</option>
                        {
                    ...
                    <div className="mb-1  ">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Subject</label>
                    ...
                    <div className="mb-1">
                      ...
                      <select className="form-select form-focus label-color heading-14 " value={teacherId} onChange={(e) => setTeacherId(e.target.value)} aria-label="Default select example">
                        <option selected>--Choose--</option>
                    ...
                    <div className="mb-3 for-media-margin">
                      ...
                      <input type="email" className="form-control form-focus-input form-control-md heading-14 grey-input-text-color input-border-color" value={lesson} onChange={(e) => handleLesson(e.target.value)} style={{ borderRadius: '5px', marginTop: '-5px' }} id="exampleFormControlInput12" placeholder="Enter Lesson No" />
                    </div>
                    <div className='pt-1'>
                    ...
                    <div className="mb-3">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Upload Course Image</label>
                      <input type="file" className="form-control form-control-sm" id="exampleFormControlInput1" onChange={(e) => setCourseImage(e.target.files[0])} placeholder="Select Class" accept='.jpg, .png, .jpeg' />
                    </div>
                    <div className="mb-3">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Upload Course File</label>
                      <input type="file" className="form-control form-control-sm" id="exampleFormControlInput1" onChange={(e) => setCourseFile(e.target.files[0])} placeholder="Select Class" accept='.pdf' />
                    </div>
                    <div className="mb-1">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Status</label>
                      <select className="form-select form-focus label-color heading-14 " value={status} onChange={(e) => setStatus(e.target.value)} aria-label="Default Status">
                ...
                <div className="offcanvas-body pt-0">
                  <div className="input " >
                    ...
                    <div className="mb-3 " style={{ display: 'flex', }}>
                      <div className='w-100'>
                        <label for="exampleFormControlInput1" className="form-label label-color">Course Image</label>
                        {
                          swicthInput ? (
                            <input type="file" className="form-control" id="exampleFormControlInput1" onChange={(e) => setImageFile(e.target.files[0])} placeholder="select file" accept='.jpg, .png, .jpeg' />
                          )
                            :
                            (
                              <input type="text" className="form-control" id="exampleFormControlInput1" value={imageFile} placeholder="name@example.com" />
                            )
                        }
                      </div>
                      <div style={{ margin: 'auto', paddingTop: '30px', paddingLeft: '5px' }}>
                        {
                          swicthInput ? (
                            <button type="button" className="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput(!swicthInput)} >Edit</button>
                          )
                            :
                            (
                              <button type="button" className="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput(!swicthInput)} >View</button>
                            )
                        }
                      </div>
                    </div>
                    ...
                    <div className="mb-3 " style={{ display: 'flex', }}>
                      <div className='w-100'>
                        <label for="exampleFormControlInput1" className="form-label label-color">Course File</label>
                        {
                          swicthInput2 ? (
                            <input type="file" className="form-control" id="exampleFormControlInput1" onChange={(e) => setImageFile2(e.target.files[0])} placeholder="select file" accept='.jpg, .png, .jpeg' />
                          )
                            :
                            (
                              <input type="text" className="form-control" id="exampleFormControlInput1" value={imageFile2} placeholder="name@example.com" />
                            )
                        }
                      </div>
                      <div style={{ margin: 'auto', paddingTop: '30px', paddingLeft: '5px' }}>
                        {
                          swicthInput2 ? (
                            <button type="button" className="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput2(!swicthInput2)} >Edit</button>
                          )
                            :
                            (
                              <button type="button" className="btn btn-outline-success my-green heading-14 " onClick={() => setSwicthInput2(!swicthInput2)} >View</button>
                            )
                        }
                      </div>
                    </div>
