...
const Income_category = () => {
  ...
  const MyIncomeCategoryPostApi = async () => {
    if (FuncValidation()) {
      ...
      formData.append("incomeCategoryName", name);
  ...
  const MyIncomeGetAllApi = async () => {
    setLoader(true);
    try {
      const response = await IncomeCategorygetAllApi(
        searchKey,
        pageNo,
        pageSize
      );
  ...
  const MyIncomCateGetById = async (id) => {
    ...
    try {
      ...
      // console.log("Income category Get By Id", response);

      if (response?.status === 200) {
        // toast.success(response?.data?.msg)
        setName(response?.data?.category?.incomeCategoryName);
  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
            ...
            <nav style={{ "--bs-breadcrumb-divider": "'>'" }} aria-label="breadcrumb" >
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14">
                  <Link href="#">Income Category</Link>
                </li>
              </ol>
            </nav>
          </div>
        ...
        <h5
          className="ms-3 mb-2 margin-minus22 heading-16 heading-responsive"
          ...
          <div className="table-container px-3 table-responsive">
            <table className="table table-sm table-striped">
              <thead className="">
                ...
                >
                  <th className="no-wrap" style={{ width: "10%" }}>
                    #
                  </th>
                  <th className="no-wrap" style={{ width: "70%" }}>Income Category</th>
                  <th className="no-wrap" style={{ width: "20%" }}>Action</th>
                </tr>
              </thead>
              <tbody className="heading-14 align-middle greyTextColor">
                {
                  incomeCategoryData && incomeCategoryData?.length > 0 ? (
                    incomeCategoryData?.map((item, index) => (
                      <tr className="heading-14">
                        <td className=" greyText no-wrap">{index + 1 + (currentPage - 1) * pageSize}</td>
                        <td className=" greyText no-wrap">{item.incomeCategoryName}</td>
                            ...
                            <ul className="dropdown-menu anchor-color heading-14">
                              <li>
                                <Link
                                  ...
                                  onClick={(e) => MyIncomCateGetById(item.id)}
                                >
                                  Edit
                                </Link>
                              </li>
              ...
              >
                ...
                <div className="offcanvas-body pt-0">
                  ...
                  <div className="my-button11 ">
                    <button
                      type="button"
                      className="btn btn-outline-success heading-16 my-green"
                      onClick={MyIncomeCategoryPostApi}
                    >
                      Add Income Category
                    </button>
                    <button
            ...
            >
              ...
              <div className="offcanvas-body pt-0">
                ...
                <div className="my-button11">
                  <button
                    type="button"
                    className="btn btn-outline-success heading-16 btn-bgAndColor"
                ...
                <div className="sure-main-container mt-4">
                  <div className="sure-container">
                    ...
                    <div className="form-check mt-1">
                      ...
                      />
                      <label
                        className="form-check-label agree"
