...
const Expense_category = () => {
  ...
  const MyExpenseGetAllApi = async () => {
    ...
    try {
      ...
      // console.log('get all data in expense',response)
      if (response?.status === 200) {
        // toast.success(response?.data?.msg)
        setExpenseCategoryData(response?.data?.categories)
        setCurrentPage(response?.data?.currentPage);
        setTotalPages(response?.data?.totalPages);
        setShowDataImage(true)
        setLoader(false)
      } else {
  ...
  const MyExpenseCateGetById = async (id) => {
    ...
    try {
      ...
      // console.log('get by id dataa',response)
      if (response?.status === 200) {
        // toast.success(response?.data?.msg)
        setName(response?.data?.category.expenseCategoryName)
        setType(response?.data?.category.type)
        setLoader(false)
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3 " data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" to={''} onClick={ClearHandle}>+ Add Expense Category</Link>
          </div>
        </div>
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap' style={{ width: '70%' }}>Expense Category</th>
                  <th className='no-wrap' style={{ width: '20%' }}>Action</th>
                          ...
                          <ul className="dropdown-menu anchor-color heading-14">
                            <li>
                              <Link
                                ...
                                data-bs-target="#offcanvasRight1234"
                                aria-controls="offcanvasRight1234"
                                onClick={() => MyExpenseCateGetById(item.id)}
                              >
                                Edit
                              </Link>
                            </li>
              ...
              <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" ref={offcanvasRef}>
                ...
                <div className="offcanvas-body pt-0">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1" value={name} onChange={(e) => handleType(e.target.value)} placeholder="Expense Category Name" />
                  </div>
                  <div className='pt-1'>
                    {isValidTypeRequired && (
