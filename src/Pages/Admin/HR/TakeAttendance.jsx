      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            <CSVLink className={`col-lg-2 col-md-3 col-sm-4 col-6 btn AddBtnn font14 heading-14 export1 my-own-outline-btn me-2 ${attendanceDataByMonth?.length <= 0 ? 'disabled' : ''}`} data={csvData} filename={"orders.csv"} onClick={Download_Slip}>
              <span>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 ">
                ...
                <span className="input-group-text button-bg-color button-color heading-14 font-color " style={{ cursor: 'pointer', height: "34px" }} id="basic-addon2" onClick={MyAttendanceGetAllApiByMonth}>Search</span>
              </div>
            </div>
            <div class="dropdown">
