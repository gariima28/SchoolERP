      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <button type="button" className={`btn export2 btn-outline-secondary my-own-outline-btn me-2 ${BookManagerData?.length <= 0 ? 'disabled' : ''}`} onClick={handleDownloadPdf}>
              <span>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 search-responsive">
                ...
                <span className="input-group-text button-bg-color button-color heading-14 font-color " style={{ cursor: 'pointer', height: "34px" }} id="basic-addon2" onClick={MyBookIssueGetAllApi}>Search</span>
              </div>
            </div>
        ...
        <div className="main-content-conatainer pt-1 ">
          ...
          <div className='my-button11 mb-3'>
            <button type="button" className="btn btn-outline-success my-button112233" onClick={MyBookIssueGetAllApi}>Search</button>
            ...
            <table className="table table-sm table-striped text-center ">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th className='no-wrap'>Due Date</th>
