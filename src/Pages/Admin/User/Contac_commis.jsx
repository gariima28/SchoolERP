...
//   // Reset percentage and amount when deduction type changes
//   useEffect(() => {
//     if (addDeductionType === 'PERCENTAGE') {
//       setAddValue('amount', '0');
//       setAddValue('percentage', '');
//     } else if (addDeductionType === 'AMOUNT') {
...
//       setAddValue('amount', '');
//     }
//   }, [addDeductionType, setAddValue]);

//   useEffect(() => {
//     if (editDeductionType === 'PERCENTAGE') {
//       setEditValue('amount', '0');
//       setEditValue('percentage', editDeduction?.percentage || '');
//     } else if (editDeductionType === 'AMOUNT') {
//       setEditValue('percentage', '0');
//       setEditValue('amount', editDeduction?.amount || '');
//     } else {
//       setEditValue('percentage', '');
//       setEditValue('amount', '');
//     }
//   }, [editDeductionType, setEditValue, editDeduction]);
...
//       const formData = new FormData();
//       formData.append('deductionNameId', data.deductionNameId);
//       formData.append('deductionType', data.deductionType);
...
//     setEditDeduction(item);
//     setEditValue('deductionNameId', item.deductionNameId || item.statutoryDeductionId || '');
//     setEditValue('deductionType', item.deductionType || '');
...
//       const response = await Conatct_Deduction_PutApi(myUserID, editDeduction.statutoryDeductionId || editDeduction.id, formData);
//       if (response?.status === 200 && response?.data?.status === 'success') {
//         toast.success(response.data.message);
//         getAllDeductionNameByStaffId();
//         const offcanvasElement = document.getElementById('editDeductionOffcanvas');
...
//                   control={addControl}
//                   rules={{
//                     required: addDeductionType === 'PERCENTAGE' ? 'Percentage is required' : false,
//                     pattern: addDeductionType === 'PERCENTAGE' ? {
//                       value: /^\d+(\.\d{1,2})?$/,
...
//                     <input
//                       type="text"
//                       className={`form-control form-control-sm font14 grey-input-text-color input-border-color ${!addErrors.percentage && field.value && addDeductionType === 'PERCENTAGE' ? 'valid-indicator' : ''}`}
//                       id="percentage"
//                       placeholder="Enter percentage"
//                       disabled={addDeductionType !== 'PERCENTAGE'}
//                       {...field}
...
//                   control={addControl}
//                   rules={{
//                     required: addDeductionType === 'AMOUNT' ? 'Amount is required' : false,
//                     pattern: addDeductionType === 'AMOUNT' ? {
//                       value: /^\d+(\.\d{1,2})?$/,
//                       message: 'Enter a valid amount (e.g., 1000.00)',
//                     } : undefined,
//                   }}
...
//                     <input
//                       type="text"
//                       className={`form-control form-control-sm font14 grey-input-text-color input-border-color ${!addErrors.amount && field.value && addDeductionType === 'AMOUNT' ? 'valid-indicator' : ''}`}
//                       id="amount"
//                       placeholder="Enter amount"
//                       disabled={addDeductionType !== 'AMOUNT'}
//                       {...field}
//                       aria-describedby="amountError"
//                     />
//                   )}
...
//                       data-bs-target="#deleteFeeDiscount"
//                       aria-controls="deleteFeeDiscount"
//                       onClick={() => setDelDeductionId(item.statutoryDeductionId)}
//                     >
//                       Delete
//                     </button>
//                   </td>
...
//                 control={editControl}
//                 rules={{
//                   required: editDeductionType === 'PERCENTAGE' ? 'Percentage is required' : false,
//                   pattern: editDeductionType === 'PERCENTAGE' ? {
//                     value: /^\d+(\.\d{1,2})?$/,
//                     message: 'Enter a valid percentage (e.g., 10.00)',
//                   } : undefined,
//                 }}
...
//                   <input
//                     type="text"
//                     className={`form-control form-control-sm font14 grey-input-text-color input-border-color ${!editErrors.percentage && field.value && editDeductionType === 'PERCENTAGE' ? 'valid-indicator' : ''}`}
//                     id="editPercentage"
//                     placeholder="Enter percentage"
//                     disabled={editDeductionType !== 'PERCENTAGE'}
//                     {...field}
...
//                 control={editControl}
//                 rules={{
//                   required: editDeductionType === 'AMOUNT' ? 'Amount is required' : false,
//                   pattern: editDeductionType === 'AMOUNT' ? {
//                     value: /^\d+(\.\d{1,2})?$/,
//                     message: 'Enter a valid amount (e.g., 1000.00)',
//                   } : undefined,
//                 }}
...
//                   <input
//                     type="text"
//                     className={`form-control form-control-sm font14 grey-input-text-color input-border-color ${!editErrors.amount && field.value && editDeductionType === 'AMOUNT' ? 'valid-indicator' : ''}`}
//                     id="editAmount"
//                     placeholder="Enter amount"
//                     disabled={editDeductionType !== 'AMOUNT'}
//                     {...field}
//                     aria-describedby="editAmountError"
//                   />
//                 )}
