...
import { addNewDropPointApi, getAllRouteApi } from 'src/Utils/Apis';
    ...
    try {
      ...
      if (response?.status === 200) {
        if (response?.data?.status === 'success') {
          ...
          setTimeout(() => {
            navigate('/admin/transport/dropPoint');
          }, 1000);
        }
        else {
          setloaderState(false);
            ...
            <div className="bg-white cardradius p-3">
              <form className="row g-3" onSubmit={handleSubmit(AddNewDropPoint)}>
                <div className="col-md-6 col-sm-12 col-12">
                  <label htmlFor="dropName" className="form-label font14">Route  <span className='text-danger'>*</span></label>
