...
import { deleteDropPointApi, getAllDropPointApi, getDropPointCSVDataApi, getDropPointDataByIdApi, updateDropPointDataApi } from 'src/Utils/Apis';
...
const DropPoint = () => {
    ...
    const handleKeyDown = (e) => {
        if (e.key === 'Backspace') {
            setTimeout(() => {
                ...
                if (updatedValue !== '') {
                    getAllDropPointData(updatedValue);
                    setClick(true);
                }
    ...
    const handleAddButton = () => {
        navigate('/admin/transport/dropPoint/addDropPoint')
    }
                    ...
                    <div className="row pb-3 gap-xl-0 gap-3">
                        ...
                        <div className="col-xxl-8 col-xl-9 col-lg-12 col-sm-12 pe-0">
                            <ActionControls
                                ...
                                searchAction={getAllDropPointData}
