...
const AdminDashboard = () => {
  ...
  const sideBarCardsData = {
    ...
    intro: 'Get an instant snapshot of your resources. These cards show live counts for <b>Students, Vehicles, Drivers, and Staff</b>'
  }
  const sideBarAttendanceData = {
    title: 'The Pulse of Your School',
    intro: "Monitor daily activity effortlessly. This graph visualizes <b>Today's Attendance</b> trends. You can also use the button to jump directly to detailed attendance records.",
  }
  const sideBarnoticeEventData = {
    title: 'Stay Connected',
    intro: "Never miss a beat. Check this section for <b>Upcoming Holidays, Notices, and Events</b> to keep the whole school aligned on the schedule.",
  }
