                ...
                <div className="main-content-conatainer pt-1 ">
                    ...
                    <div className="row mb-3 buttons-topss">
                        <div className='my-button11 heading-16'>
                            <button type="button" class="btn  my-green" >Search</button>
                      ...
                      <p className='ms-1' style={{ color: 'red', fontSize: '14px', marginTop: '-18px' }}>
                        jpg and png supported
                                    ...
                                    <div className='my-button11 '>
                                        <button type="button" className="btn  heading-16 btn-bgAndColor" >Add Syllabus</button>
                ...
                <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight1234" aria-labelledby="offcanvasRightLabel">
                    {
                      ...
                      <p className='ms-1' style={{ color: 'red', fontSize: '14px', marginTop: '-18px' }}>
                        jpg and png supported
                                    ...
                                    <div className='my-button11'>
                                        <button type="button" className="btn  heading-16 btn-bgAndColor" >Update Syllabus</button>
                                        <button type="button" className="btn cancelButtons text-black heading-16">Cancel</button>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="row mb-3 buttons-topss">
                                    <div className='my-button11 heading-16 py-2'>
                                        <button type="button" class="btn  my-green" >Download</button>
