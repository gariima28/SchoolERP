...
import { getAdminProfileApi, getParentProfileApi, getStudentProfileApi, getStudentProfileDataApi, getSuperAdminProfileApi, getTeacherProfileApi } from 'src/Utils/Apis';
                    ...
                    <div className="col-md-8 col-sm-6 col-6">
                        <div className="d-flex align-self-center mt-1">
                            ...
                            <div className="row p-2 ms-2 me-md-0 me-1">
                                <Link className={`d-flex text-decoration-none text-black p-0 ${role === 'SUPERADMIN' ? 'cursorrrr' : ''}`} to={role === 'SUPERADMIN' ? '' : role === 'ADMIN' ? '/admin/settings/myAccount' : role === 'USER' ? '/teacher/profile' : role === 'PARENT' ? '/parent/profile' : '/student/profile'}>
